...
const CFG = {
  ...
  // PIN de acceso a la agenda privada
...
const normalizeAppointment = api => {
  const dur = api.service?.duration_minutes ?? api.duration_minutes ?? CFG.bloqueMin;
  return {
...
const mapToApiAppointment = turno => ({
  service_id: SERVICE_ID_MAP[turno.svcId] || 1, 
...
/* ═══════════════════════════════════════════════════
   ...
   ──────────────────────────────────────────────────
   Los turnos se guardan en el navegador. 
═══════════════════════════════════════════════════ */

const STORE_KEY = 'ava_turnos_v1';
